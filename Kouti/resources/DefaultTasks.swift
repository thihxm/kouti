...
struct DefaultTasks {
    static let tasks: [TaskModel] =
        [TaskModel(name: "Tomar água", tag: .health, frequency: [.monday,.tuesday,.wednesday,.thursday,.friday,.saturday,.sunday], monster: MonsterModel(name: "undef", titles: [])),
         ...
         TaskModel(name: "Menos celular", tag: .health, frequency: [.monday,.tuesday,.wednesday,.thursday,.friday,.saturday,.sunday], monster: MonsterModel(name: "undef", titles: [])),
         ...
         TaskModel(name: "Pequenas pausas", tag: .work, frequency: [.monday,.tuesday,.wednesday,.thursday,.friday], monster: MonsterModel(name: "undef", titles: [])),
