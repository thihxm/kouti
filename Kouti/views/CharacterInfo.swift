...
struct CharacterInfo<Content>: View {
    typealias Content = Identifiable & View
    var pages: [Content]
...
struct CharacterInfo_Previews: PreviewProvider {
    static var previews: some View {
        CharacterInfo(pages: [BestiaryGrid(
        ...
        CharacterInfo(pages: [ItemsGrid(items: [ItemModel(name: "ItemA", type: .top, price: 10, amount: 1),
